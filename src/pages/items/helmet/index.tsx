...
export const itemsQuery: FetchQueryOptions<BaseItem[]> = {
  ...
  async queryFn() {
    const res = await apiClient.get<GetResponse<BaseItem[]>>("helmetItems");
...
export default function HelmetItemPage() {
  ...
  return (
    <main className="space-y-4 p-8 pt-6">
      <div className="flex flex-wrap w-full justify-between gap-2">
        <h1 className="text-3xl font-bold tracking-tight">Helmet Items</h1>
