...
export const itemsQuery: FetchQueryOptions<BaseItem[]> = {
  queryKey: ["items", "motor"],
  async queryFn() {
    const res = await apiClient.get<GetResponse<BaseItem[]>>("motorItems", {
...
export default function MotorItemPage() {
  ...
  return (
    <main className="space-y-4 p-8 pt-6">
      <div className="flex flex-wrap w-full justify-between gap-2">
        <h1 className="text-3xl font-bold tracking-tight">Motor Items</h1>
